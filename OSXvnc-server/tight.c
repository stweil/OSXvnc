...
{                                                                             \
    ...
    int dx, dy;                                                               \
                                                                              \
    fbptr = (CARD##bpp *)                                                     \
        &rfbGetFramebuffer()[y * rfbScreen.paddedWidthInBytes + x * (bpp/8)]; \
                                                                              \
    colorValue = *fbptr;                                                      \
    ...
    int x, y, count;
{
    ...
    fbptr = (CARD32 *)
        &rfbGetFramebuffer()[y * rfbScreen.paddedWidthInBytes + x * 4];
...
{                                                                           \
    ...
    int inRed, inGreen, inBlue;                                             \
                                                                            \
    fbptr = (CARD##bpp *)                                                   \
        &rfbGetFramebuffer()[y * rfbScreen.paddedWidthInBytes +             \
                             x * (bpp / 8)];                                \
                                                                            \
    while (count--) {                                                       \
        pix = *fbptr++;                                                     \
